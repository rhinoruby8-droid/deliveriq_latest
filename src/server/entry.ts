...
import cms_users_get from "./api/cms/users/GET";
import cms_users_post from "./api/cms/users/POST";
import cms_users_put from "./api/cms/users/PUT";
import cms_users_delete from "./api/cms/users/DELETE";
import razorpay_order_post from "./api/razorpay/order/POST";
import razorpay_verify_post from "./api/razorpay/verify/POST";
import cms_purchases_get from "./api/cms/purchases/GET";
import cms_purchases_post from "./api/cms/purchases/POST";
import cms_purchases_delete from "./api/cms/purchases/DELETE";
import cms_settings_gateways_get from "./api/cms/settings/gateways/GET";
import cms_settings_gateways_post from "./api/cms/settings/gateways/POST";
import cms_email_templates_get from "./api/cms/email-templates/GET";
import cms_email_templates_post from "./api/cms/email-templates/POST";
import cms_email_templates_delete from "./api/cms/email-templates/DELETE";
...
app.post("/api/user/register-session", user_register_session_post as any);
app.get("/api/user/sessions/:sessionId/join", requireAuth as any, user_session_join_get as any);
app.get("/api/proxy/join", proxy_join_get as any);
app.post("/api/user/telemetry/watch-time", requireAuth as any, user_watch_time_post as any);
app.get("/api/cms/users", requireRole(['admin']) as any, cms_users_get as any);
app.post("/api/cms/users", requireRole(['admin']) as any, cms_users_post as any);
app.put("/api/cms/users", requireRole(['admin']) as any, cms_users_put as any);
app.delete("/api/cms/users", requireRole(['admin']) as any, cms_users_delete as any);
app.post("/api/razorpay/order", razorpay_order_post);
app.post("/api/razorpay/verify", razorpay_verify_post);
app.get("/api/cms/purchases", requireRole(['admin']) as any, cms_purchases_get as any);
app.post("/api/cms/purchases", requireRole(['admin']) as any, cms_purchases_post as any);
app.delete("/api/cms/purchases", requireRole(['admin']) as any, cms_purchases_delete as any);
app.get("/api/cms/settings/gateways", requireRole(['admin']) as any, cms_settings_gateways_get as any);
app.post("/api/cms/settings/gateways", requireRole(['admin']) as any, cms_settings_gateways_post as any);

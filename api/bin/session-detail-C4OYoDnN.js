...
import { d as distExports, u as useCmsContent, F as FALLBACK_CMS_CONTENT, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, a as ArrowRight, g as getUserToken, H as Helmet } from "./entry-server-DE4KYu_X.js";
import { V as VideoPlayer } from "./VideoPlayer-Ci_jFogm.js";
import { P as PageHtmlRenderer } from "./PageHtmlRenderer-CwMkbELf.js";
import { A as ArrowLeft } from "./arrow-left-yu9kAD9T.js";
import { C as Clock } from "./clock-BAydS_DM.js";
import { T as Tag } from "./tag-BjZ_ukFd.js";
import { C as CirclePlay } from "./circle-play-CAmv6ZGx.js";
import { C as CircleCheckBig } from "./circle-check-big-C4nLGtI1.js";
import { m as motion } from "./proxy-DqB2qEf9.js";
import { U as Users } from "./users-DtqXncLI.js";
import { G as Globe } from "./globe-CkkgYOly.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
import "http2";
import "async_hooks";
import "./DynamicForm-DRSDZb3t.js";
const fadeUp = {
...
function SessionDetailPage() {
  ...
  if (!session) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("main", { className: "min-h-screen flex flex-col items-center justify-center text-center px-6 gap-6", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-4xl font-black text-[#2C2F38]", children: "404" }, void 0, false, {
        fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/session-detail.tsx",
        lineNumber: 86,
        columnNumber: 9
      }, this),
  ...
  const widgets = {
    ...
    SessionRegistrationPanel: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "border border-border/60 bg-background rounded-2xl overflow-hidden shadow-2xl", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-6 py-5 border-b border-border/40 bg-card/30 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-6 py-5 border-b border-border/40 bg-card/10", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-3.5 text-xs", children: [

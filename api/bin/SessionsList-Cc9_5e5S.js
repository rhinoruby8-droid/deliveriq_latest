...
import { u as useCmsContent, r as reactExports, j as jsxDevRuntimeExports, d as distExports, X, C as Calendar } from "./entry-server-Dfk5y7JA.js";
import { C as ChevronDown } from "./chevron-down-1F7w9iVX.js";
import { T as Tag } from "./tag-BI3bLRzn.js";
import { C as Clock } from "./clock-DkXFKJXe.js";
import { U as Users } from "./users-BDGVB3cQ.js";
import { G as Globe } from "./globe-C58ME3xx.js";
import { C as CirclePlay } from "./circle-play-Dr7BXI9F.js";
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4 pt-4 border-t border-[#2C2F38]/40 mt-auto diq-card-footer", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-end gap-2 pt-3 border-t border-[#2C2F38]/20 diq-card-actions-row", children: [
        ...
        isPast ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          ...
          {
            to: "/replays",
            className: "inline-flex items-center gap-1.5 px-4 py-2 bg-[#2C2F38] border border-[#2C2F38] text-[#8A8D96] hover:bg-[#C79A4E]/10 hover:border-[#C79A4E]/30 hover:text-[#C79A4E] text-[11px] font-semibold rounded-sm transition-all whitespace-nowrap diq-card-replay-btn",
            children: [

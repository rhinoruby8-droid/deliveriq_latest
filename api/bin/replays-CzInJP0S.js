...
import { r as reactExports, b as jsxRuntimeExports, d as distExports, u as useCmsContent, F as FALLBACK_CMS_CONTENT, g as getUserToken, t as trackWatchTime, c as trackEvent, j as jsxDevRuntimeExports, H as Helmet, X, A as AuthDialog, a as ArrowRight } from "./entry-server-BK6KGtXC.js";
import { P as PageHtmlRenderer } from "./PageHtmlRenderer-C0aDPmiO.js";
import { S as SpeakerDialog } from "./SpeakerDialog-CDu3fLLz.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-DtOsgoqC.js";
...
function ReplaysArchiveWidget({ onWatchReplay, onSpeakerClick }) {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { initial: "hidden", animate: "visible", variants: stagger, className: "diq-replays-archive", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeUp, custom: 0, className: "flex flex-wrap gap-2 mb-12 diq-replays-filters", children: tags.map((tag) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      ...
      false,
      {
        fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
        lineNumber: 51,
        columnNumber: 11
      },
      this
    ...
    filteredReplays.length > 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 diq-replays-grid", children: filteredReplays.map((session) => {
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-5 flex-1 flex flex-col justify-between diq-replay-card-body", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between gap-2 mb-2 diq-replay-card-meta", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] font-bold text-primary uppercase tracking-wider bg-primary/5 border border-primary/10 px-2 py-0.5 rounded-sm diq-replay-card-tag", children: session.tag }, void 0, false, {
                    fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
                    lineNumber: 96,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-muted-foreground flex items-center gap-1 diq-replay-card-duration", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "font-bold text-base text-foreground mb-2 leading-snug group-hover:text-primary transition-colors diq-replay-card-title", children: session.title }, void 0, false, {
                  fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
                  lineNumber: 103,
                  columnNumber: 21
                }, this),
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-xs text-muted-foreground leading-relaxed mb-4 line-clamp-2 diq-replay-card-desc", children: session.description }, void 0, false, {
                  fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
                  lineNumber: 106,
                  columnNumber: 21
                }, this)
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "pt-4 border-t border-border/40 flex items-center gap-2 diq-replay-card-footer", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-[10px] text-muted-foreground font-medium truncate diq-replay-card-speakers flex flex-wrap gap-1 items-center", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-14 h-14 rounded-full border border-border flex items-center justify-center mb-6 diq-replays-empty-icon-wrap", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "img",
            {
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-lg font-semibold text-foreground mb-2 diq-replays-empty-title", children: "Replays coming soon." }, void 0, false, {
            fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
            lineNumber: 162,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-muted-foreground max-w-sm leading-relaxed diq-replays-empty-desc", children: "The first live sessions are on their way. Once they've aired, replays will appear here — filterable by topic and available on demand." }, void 0, false, {
            fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/replays.tsx",
            lineNumber: 165,
            columnNumber: 11
          }, this),

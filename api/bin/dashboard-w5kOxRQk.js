...
import { m as createLucideIcon, d as distExports, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, H as Helmet, n as ChevronRight, a as ArrowRight, B as Button, l as fetchMe, o as fetchDashboardData, p as LogOut, q as removeUserToken } from "./entry-server-DMO3DLBc.js";
import { D as Dashboard$1, V as Video } from "./Dashboard-pycTSA-C.js";
...
import { B as BookOpen, S as Settings } from "./settings-JC6mGZ87.js";
import { Z as Zap } from "./zap-D8vS_Y4G.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
function Dashboard() {
  ...
  const handleJoinCall = async (sessionId) => {
    try {
      ...
      const token = localStorage.getItem("deliveriq_user_token");

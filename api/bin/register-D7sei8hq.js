...
import { u as useCmsContent, F as FALLBACK_CMS_CONTENT, d as distExports, r as reactExports, j as jsxDevRuntimeExports, H as Helmet, s as setUserToken } from "./entry-server-AzqEiOmj.js";
import { C as CircleCheckBig } from "./circle-check-big-BBTNQn_d.js";
import { T as Tag } from "./tag-tGV9Qwij.js";
import { A as ArrowRight } from "./arrow-right-CE626uEa.js";
import { A as ArrowLeft } from "./arrow-left-Dr4SJOqn.js";
import "../index.js";
import "tty";
import "util";
import "os";
    ...
    try {
      ...
      const sessionRes = await fetch("/api/user/register-session", {
        ...
        body: JSON.stringify({
          ...
          gateway: finalPrice > 0 ? gateway : void 0
        })
      });
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-6 md:p-8", children: [
        ...
        success ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col items-center justify-center text-center py-12 gap-4", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-6", children: [
            ...
            finalPrice > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-2 mt-2", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("label", { className: "font-semibold text-sm text-[#F0EDE8]", children: "Select Payment Gateway" }, void 0, false, {
                fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/pages/register.tsx",
                lineNumber: 340,
                columnNumber: 21
              }, this),
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "select",
                {
                  ...
                  className: "h-12 w-full rounded-[10px] border border-[#2C2F38] bg-[#14161B] px-4 py-2 text-sm text-[#F0EDE8] transition-colors focus:outline-none focus:border-[#C79A4E] focus:ring-1 focus:ring-[#C79A4E] cursor-pointer",
                  children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mt-6", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              "button",
              {
                ...
                children: [
                  submitting ? "Processing Registration..." : finalPrice > 0 ? "Complete Registration & Pay" : "Complete Registration",
                  " ",
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ArrowRight, { size: 18 }, void 0, false, {
                    fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/pages/register.tsx",
                    lineNumber: 359,

...
import { m as createLucideIcon, r as reactExports, j as jsxDevRuntimeExports, B as Button, X, v as cn, w as Menu } from "./entry-server-DIa57ZvY.js";
/**
...
function Dashboard({
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: cn("flex h-full w-full overflow-hidden bg-[#14161B] text-foreground", className), children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex h-14 items-center justify-between px-4 border-b border-border", children: [
        logo.href ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: logo.href, className: "flex items-center gap-2 font-semibold text-sm", children: [
          logo.image && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("img", { src: logo.image, alt: logo.text, className: "h-5 w-5" }, void 0, false, {
            fileName: "D:/deliverIQ-new/DeliverIQ_2/src/layouts/Dashboard.tsx",
            lineNumber: 95,
            columnNumber: 19
          }, this),
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-1 flex-col min-w-0 overflow-hidden relative bg-[#14161B] text-foreground", children: [

...
import { j as jsxDevRuntimeExports, R as React4 } from "./entry-server-BzYaCnx0.js";
...
function SafeHtml({ html, as = "div", ...props }) {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Component, { ...props, dangerouslySetInnerHTML: { __html: html } }, void 0, false, {
    fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/SafeHtml.tsx",
    lineNumber: 11,
    columnNumber: 10
  }, this);
}
    ...
    if (part.startsWith("[") && part.endsWith("]")) {
      ...
      if (widgets[widgetName] !== void 0) {
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(React4.Fragment, { children: widgets[widgetName] }, i, false, {
          fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/PageHtmlRenderer.tsx",
          lineNumber: 34,
          columnNumber: 20
        }, this);
      }

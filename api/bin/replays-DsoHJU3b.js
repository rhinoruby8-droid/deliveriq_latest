...
import { r as reactExports, a as jsxRuntimeExports, u as useCmsContent, F as FALLBACK_CMS_CONTENT, t as trackWatchTime, j as jsxDevRuntimeExports, H as Helmet, X, d as distExports } from "./entry-server-f1u3uq1V.js";
import { P as PageHtmlRenderer } from "./PageHtmlRenderer-8z0Dtvku.js";
import { t as trackEvent } from "./analytics-jZcZ4Ayp.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, a as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-BXw7Niec.js";
import { P as Play } from "./play-Cq6y-1D7.js";
...
function ReplaysArchiveWidget({ setPlayingSession }) {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { initial: "hidden", animate: "visible", variants: stagger, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeUp, custom: 0, className: "flex flex-wrap gap-2 mb-12", children: tags.map((tag) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      ...
      false,
      {
        fileName: "D:/DeliverIQ/DeliverIQ/src/pages/replays.tsx",
        lineNumber: 46,
        columnNumber: 11
      },
      this
...
function ReplaysPage() {
  ...
  import("./entry-server-f1u3uq1V.js").then((n) => n.R).then(({ useEffect }) => {
    useEffect(() => {

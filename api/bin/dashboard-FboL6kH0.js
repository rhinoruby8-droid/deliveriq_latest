...
import { m as createLucideIcon, d as distExports, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, H as Helmet, n as ChevronRight, a as ArrowRight, l as fetchMe, o as fetchDashboardData, B as Button, p as LogOut, q as removeUserToken } from "./entry-server-BK6KGtXC.js";
import { D as Dashboard$1, V as Video } from "./Dashboard-CKhAFXdU.js";
import { C as CheckoutButton } from "./CheckoutButton-D0WC20g4.js";
import { J as JoinCallButton } from "./JoinCallButton-DCerH-In.js";
import { C as CirclePlay } from "./circle-play-BFDy5Kz8.js";
import { m as motion } from "./proxy-DtOsgoqC.js";
import { C as Clock } from "./clock-DlzmH1HB.js";
import { S as Sparkles } from "./sparkles-KWrZQDeY.js";
import { B as BookOpen, S as Settings } from "./settings-BLpzpqBz.js";
import { Z as Zap } from "./zap-B9rDXLsu.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
function Dashboard() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "h-screen bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative w-10 h-10", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 border-2 border-primary/10 rounded-full" }, void 0, false, {
          fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/dashboard.tsx",
          lineNumber: 65,
          columnNumber: 13
        }, this),
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 0, className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "hidden sm:flex items-center gap-2 bg-card border border-border/60 px-4 py-2 rounded-xl text-xs text-slate-400", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 1, className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative overflow-hidden bg-gradient-to-b from-card to-background border border-border/60 hover:border-primary/30 rounded-2xl p-6 transition-all duration-350 group shadow-lg", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-8", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:col-span-3 space-y-8", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.section, { variants: fadeIn, custom: 2, children: [
                ...
                registeredSessions.length === 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-background border border-dashed border-border rounded-2xl p-10 text-center flex flex-col items-center gap-4 overflow-hidden group", children: [
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative z-10 flex flex-col items-center gap-3", children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-12 h-12 rounded-full bg-card border border-border flex items-center justify-center text-slate-500", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Calendar, { size: 20 }, void 0, false, {
                      fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/dashboard.tsx",
                      lineNumber: 275,
                      columnNumber: 23
                    }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:col-span-2 space-y-6", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 2, children: !isPro ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-gradient-to-b from-card to-background border border-primary/20 rounded-2xl p-6 overflow-hidden shadow-lg", children: [
                ...
                lineNumber: 356,
                columnNumber: 17
              }, this) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-gradient-to-b from-card to-background border border-primary/20 rounded-2xl p-6 overflow-hidden shadow-lg", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute -top-10 -right-10 w-28 h-28 bg-primary/[0.05] rounded-full blur-2xl pointer-events-none" }, void 0, false, {
                  fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/pages/dashboard.tsx",
                  lineNumber: 379,
                  columnNumber: 19
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative z-10", children: [
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-2 pt-4 border-t border-border/40", children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "#", className: "flex items-center gap-3 p-3 rounded-xl bg-card/40 hover:bg-card/80 border border-border/40 hover:border-primary/30 transition-all text-xs text-slate-300 font-medium group", children: [
                    ...
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://discord.gg/deliveriq", target: "_blank", rel: "noreferrer", className: "flex items-center gap-3 p-3 rounded-xl bg-card/40 hover:bg-card/80 border border-border/40 hover:border-primary/30 transition-all text-xs text-slate-300 font-medium group", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 3, className: "bg-background border border-border/60 rounded-2xl p-6 shadow-md", children: [

...
import { i as createLucideIcon, r as reactExports, j as jsxDevRuntimeExports, f as Check } from "./entry-server-FVqFGC_6.js";
import { C as CheckoutButton } from "./CheckoutButton-CgCjpy9d.js";
import { P as Play } from "./play-B5oVjUc9.js";
import { C as Clock } from "./clock-COkav-kP.js";
/**
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: visibleTiers.map((tier) => {
      ...
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "div",
        {
          ...
          className: `relative flex flex-col justify-between p-6 rounded-xl border transition-all duration-300 ${showOnlyPro ? "col-span-3 max-w-md mx-auto w-full" : ""} ${isSelected ? "border-[#C79A4E] bg-[#21242C]/80 shadow-[0_0_20px_rgba(199,154,78,0.15)] scale-[1.02]" : "border-[#2C2F38] bg-[#1A1D24]/40 hover:border-[#C79A4E]/30 cursor-pointer"}`,
          children: [
            tier.popular && !showOnlyPro && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-[#C79A4E] text-[#1A1D24] text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full", children: "Popular" }, void 0, false, {
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-sm font-bold text-[#F0EDE8] uppercase tracking-wider", children: tier.name }, void 0, false, {
                  fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/PricingTiers.tsx",
                  lineNumber: 113,
                  columnNumber: 19
                }, this),
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-baseline gap-1 mb-4", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-3xl font-extrabold text-white", children: [
                  "$",
                  tier.price
                ] }, void 0, true, {
                  fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/PricingTiers.tsx",
                ...
                (tier.id === "tier3" || showOnlyPro) && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-[#8A8D96]", children: "/year" }, void 0, false, {
                  fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/PricingTiers.tsx",
                  lineNumber: 119,
                  columnNumber: 60
                }, this)
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-xs text-[#8A8D96] mb-6 leading-relaxed", children: tier.description }, void 0, false, {
                fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/PricingTiers.tsx",
                lineNumber: 122,
                columnNumber: 17
              }, this),
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("ul", { className: "space-y-2.5 text-xs text-[#F0EDE8] mb-6", children: tier.features.map((feature, i) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("li", { className: "flex items-start gap-2", children: [
            ...
            !showOnlyPro && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "pt-4 border-t border-[#2C2F38]/40", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: `text-xs font-semibold px-4 py-2 rounded-lg border w-full block text-center transition-colors ${isSelected ? "bg-[#C79A4E] text-[#1A1D24] border-[#C79A4E]" : "bg-transparent text-[#8A8D96] border-[#2C2F38]"}`, children: isSelected ? "Selected" : "Select Plan" }, void 0, false, {
              fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/PricingTiers.tsx",
              lineNumber: 136,
              columnNumber: 19
            }, this) }, void 0, false, {

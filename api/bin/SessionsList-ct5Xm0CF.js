...
import { u as useCmsContent, r as reactExports, j as jsxDevRuntimeExports, d as distExports, X, C as Calendar } from "./entry-server-Cv5aoiDe.js";
import { C as ChevronDown } from "./chevron-down-Ber28wpX.js";
...
function SessionCard({ session, speakers, sponsors, isPast, onTitleClick }) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: `group border rounded-sm p-6 transition-all duration-200 h-full flex flex-col ${isPast ? "border-[#2C2F38]/60 bg-[#1A1D24]/60 opacity-80 hover:opacity-100 hover:border-[#2C2F38]" : "border-[#2C2F38] bg-[#21242C]/40 hover:border-[#C79A4E]/30"}`, children: [

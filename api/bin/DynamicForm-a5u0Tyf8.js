...
import { R as React4, r as reactExports, j as jsxDevRuntimeExports, u as useCmsContent, d as distExports } from "./entry-server-DIa57ZvY.js";
...
function EmbedRenderer({ html }) {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { ref: containerRef, className: "deliveriq-embed-container" }, void 0, false, {
    fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/EmbedRenderer.tsx",
    lineNumber: 38,
    columnNumber: 10
  }, this);
}
function DynamicForm({ formId }) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(BaseFormInner, { formId, executeRecaptcha: void 0 }, void 0, false, {
    fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
    lineNumber: 21,
    columnNumber: 10
  }, this);
}
function BaseFormInner({ formId, executeRecaptcha }) {
  ...
  if (success) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-background p-8 border border-border rounded-sm text-center", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "text-xl font-bold text-foreground mb-2", children: "Success" }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
        lineNumber: 95,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-muted-foreground", children: formDef.successMessage }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
        lineNumber: 96,
        columnNumber: 9
      }, this),
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-full max-w-2xl mx-auto flex flex-col gap-6", id: `form-wrapper-${formId}`, children: [
    ...
    matchedSession && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-background border border-border rounded-sm p-4 text-xs", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] font-bold text-primary uppercase tracking-wider block mb-1", children: matchedSession.tag }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
        lineNumber: 115,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h4", { className: "font-bold text-foreground mb-1 leading-snug", children: matchedSession.title }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
        lineNumber: 116,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-muted-foreground mb-3 leading-relaxed", children: matchedSession.description }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
        lineNumber: 117,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-muted-foreground block", children: [
        "Schedule: ",
        matchedSession.date,
        " @ ",
        matchedSession.time,
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("form", { onSubmit: handleSubmit(onSubmit), className: "flex flex-col gap-5", children: [
      ...
      formDef.fields.map((field) => {
        ...
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("label", { htmlFor: field.id, className: "text-[10px] font-bold text-muted-foreground uppercase tracking-wider", children: [
            field.label,
            " ",
            field.required && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-primary", "aria-hidden": "true", children: "*" }, void 0, false, {
              fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
              lineNumber: 134,
              columnNumber: 48
            }, this)
          ...
          field.type === "textarea" ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "textarea",
            {
              ...
              className: "h-auto w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-3 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none"
            },
            void 0,
            false,
            {
            ...
            "select",
            {
              ...
              "aria-required": field.required,
              ...register(field.id, { required: field.required }),
              className: "h-12 w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-2 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary appearance-none cursor-pointer",
              children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              "input",
              {
                ...
                "aria-required": field.required,
                ...register(field.id, { required: field.required }),
                className: "w-5 h-5 border-border bg-[#14161B] rounded text-primary focus:ring-primary"
              },
              void 0,
              false,
              {
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-sm text-muted-foreground", children: field.placeholder || field.label }, void 0, false, {
              fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/cms/DynamicForm.tsx",
              lineNumber: 170,
              columnNumber: 19
            }, this)
            ...
            "input",
            {
              ...
              "aria-required": field.required,
              ...register(field.id, { required: field.required }),
              className: "h-12 w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-2 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
            },
            void 0,
            false,
            {

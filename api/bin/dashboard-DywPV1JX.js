...
import { m as createLucideIcon, d as distExports, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, H as Helmet, n as ChevronRight, a as ArrowRight, l as fetchMe, o as fetchDashboardData, B as Button, p as LogOut, q as removeUserToken } from "./entry-server-DIa57ZvY.js";
import { D as Dashboard$1, V as Video } from "./Dashboard-CyDjBJjc.js";
import { C as CheckoutButton } from "./CheckoutButton-DT851MJP.js";
import { J as JoinCallButton } from "./JoinCallButton-BDnUINoz.js";
import { C as CirclePlay } from "./circle-play-B3EJLKwH.js";
import { m as motion } from "./proxy-Ebj0bgWW.js";
import { C as Clock } from "./clock-CeExO-S9.js";
import { S as Sparkles } from "./sparkles-DEBkFd4p.js";
import { B as BookOpen, S as Settings } from "./settings-BG8tm-f6.js";
import { Z as Zap } from "./zap-Cw3YfYlJ.js";
import "../index.js";
import "tty";
import "util";
import "os";
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "h-screen bg-[#0A0B0E] flex items-center justify-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col items-center gap-4", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative w-10 h-10", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 border-2 border-primary/10 rounded-full" }, void 0, false, {
          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
          lineNumber: 65,
          columnNumber: 13
        }, this),
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 0, className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-3", children: [
                ...
                isPro ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-[#C79A4E]/20 to-[#E5C185]/10 text-[10px] font-black text-[#E5C185] uppercase tracking-widest border border-primary/30 shadow-[0_0_15px_rgba(199,154,78,0.1)]", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Crown, { className: "w-3 h-3 text-primary" }, void 0, false, {
                    fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                    lineNumber: 135,
                    columnNumber: 19
                  }, this),
                  ...
                  lineNumber: 134,
                  columnNumber: 17
                }, this) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-muted text-[9px] font-bold text-slate-400 uppercase tracking-wider border border-border/50", children: "Free Account" }, void 0, false, {
                  fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                  lineNumber: 138,
                  columnNumber: 17
                }, this)
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "hidden sm:flex items-center gap-2 bg-[#17191E] border border-border/60 px-4 py-2 rounded-xl text-xs text-slate-400", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 1, className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative overflow-hidden bg-gradient-to-b from-[#17191E] to-[#121318] border border-border/60 hover:border-primary/30 rounded-2xl p-6 transition-all duration-350 group shadow-lg", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-4", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-1.5 pt-2", children: [
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "h-1.5 w-full bg-muted/40 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    "div",
                    {
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative overflow-hidden bg-gradient-to-b from-[#17191E] to-[#121318] border border-border/60 hover:border-primary/30 rounded-2xl p-6 transition-all duration-350 group shadow-lg", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-4", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "pt-2", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(distExports.Link, { to: "/sessions", className: "inline-flex items-center gap-1 text-[11px] font-bold text-primary hover:underline group/btn", children: [
                  "Manage Schedule",
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-8", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:col-span-3 space-y-8", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.section, { variants: fadeIn, custom: 2, children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between mb-5", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h2", { className: "text-xs font-bold text-slate-400 uppercase tracking-[0.15em] flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Bookmark, { size: 12, className: "text-primary" }, void 0, false, {
                      fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                      lineNumber: 261,
                      columnNumber: 19
                    }, this),
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(distExports.Link, { to: "/sessions", className: "text-[11px] text-primary hover:underline font-bold uppercase tracking-wider", children: "Browse All" }, void 0, false, {
                    fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                    lineNumber: 264,
                    columnNumber: 17
                  }, this)
                ...
                registeredSessions.length === 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-[#121318] border border-dashed border-border rounded-2xl p-10 text-center flex flex-col items-center gap-4 overflow-hidden group", children: [
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative z-10 flex flex-col items-center gap-3", children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-12 h-12 rounded-full bg-[#17191E] border border-border flex items-center justify-center text-slate-500", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Calendar, { size: 20 }, void 0, false, {
                      fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                      lineNumber: 275,
                      columnNumber: 23
                    }, this) }, void 0, false, {
                  ...
                  "div",
                  {
                    className: "bg-[#121318] border border-border/60 hover:border-primary/30 rounded-xl p-4 flex items-center justify-between gap-4 transition-all duration-200 group",
                    children: [
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "min-w-0", children: [
                        ...
                        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "font-bold text-white text-sm mt-2 group-hover:text-primary transition-colors truncate", children: session.title }, void 0, false, {
                          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                          lineNumber: 300,
                          columnNumber: 25
                        }, this),
              ...
              upcomingOpportunities.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.section, { variants: fadeIn, custom: 3, className: "space-y-4", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(TrendingUp, { size: 14, className: "text-primary" }, void 0, false, {
                    fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                    lineNumber: 319,
                    columnNumber: 19
                  }, this),
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: upcomingOpportunities.slice(0, 4).map((session) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  distExports.Link,
                  {
                    ...
                    className: "relative bg-[#121318] border border-border/60 hover:border-primary/30 rounded-2xl p-5 transition-all duration-300 flex flex-col justify-between group overflow-hidden",
                    children: [
                      ...
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
                        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] font-bold text-primary uppercase tracking-widest bg-primary/10 px-2 py-0.5 rounded-md border border-primary/20", children: session.tag }, void 0, false, {
                          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                          lineNumber: 333,
                          columnNumber: 25
                        }, this),
                        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "font-extrabold text-white text-sm mt-3 mb-1.5 line-clamp-2 leading-snug group-hover:text-primary transition-colors", children: session.title }, void 0, false, {
                          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                          lineNumber: 334,
                          columnNumber: 25
                        }, this),
                      ...
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-1.5 text-xs font-semibold text-primary mt-5 group-hover:text-white transition-colors", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:col-span-2 space-y-6", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 2, children: !isPro ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-gradient-to-b from-[#17191E] to-[#121318] border border-primary/20 rounded-2xl p-6 overflow-hidden shadow-lg", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute -top-10 -right-10 w-28 h-28 bg-primary/[0.05] rounded-full blur-2xl pointer-events-none" }, void 0, false, {
                  fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                  lineNumber: 358,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative z-10", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "inline-flex items-center gap-1.5 rounded-md bg-primary/10 px-2.5 py-1 text-[9px] font-bold text-primary uppercase tracking-widest mb-4 border border-primary/20", children: [
                ...
                lineNumber: 356,
                columnNumber: 17
              }, this) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-gradient-to-b from-[#17191E] to-[#121318] border border-primary/20 rounded-2xl p-6 overflow-hidden shadow-lg", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute -top-10 -right-10 w-28 h-28 bg-primary/[0.05] rounded-full blur-2xl pointer-events-none" }, void 0, false, {
                  fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                  lineNumber: 379,
                  columnNumber: 19
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative z-10", children: [
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-2 pt-4 border-t border-border/40", children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "#", className: "flex items-center gap-3 p-3 rounded-xl bg-[#1C1D24]/40 hover:bg-[#1C1D24]/80 border border-border/40 hover:border-primary/30 transition-all text-xs text-slate-300 font-medium group", children: [
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(BookOpen, { className: "w-4 h-4 text-primary" }, void 0, false, {
                        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                        lineNumber: 392,
                        columnNumber: 25
                      }, this),
                      ...
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ArrowRight, { size: 12, className: "text-slate-500 group-hover:text-primary transition-colors" }, void 0, false, {
                        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                        lineNumber: 394,
                        columnNumber: 25
                      }, this)
                    ...
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://discord.gg/deliveriq", target: "_blank", rel: "noreferrer", className: "flex items-center gap-3 p-3 rounded-xl bg-[#1C1D24]/40 hover:bg-[#1C1D24]/80 border border-border/40 hover:border-primary/30 transition-all text-xs text-slate-300 font-medium group", children: [
                      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Zap, { className: "w-4 h-4 text-primary" }, void 0, false, {
                        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                        lineNumber: 397,
                        columnNumber: 25
                      }, this),
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 3, className: "bg-[#121318] border border-border/60 rounded-2xl p-6 shadow-md", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "space-y-1", children: [
                  ...
                  const inner = /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Icon, { className: "w-4 h-4 text-slate-500 group-hover:text-primary transition-colors" }, void 0, false, {
                      fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/dashboard.tsx",
                      lineNumber: 420,
                      columnNumber: 23
                    }, this),

...
import { d as distExports, r as reactExports, j as jsxDevRuntimeExports, H as Helmet, T as TriangleAlert, M as Mail, a as ArrowRight, U as User, L as Lock, s as setUserToken, c as trackEvent } from "./entry-server-BwovAg1G.js";
import { E as EyeOff } from "./eye-off-nGzmRv_c.js";
import { E as Eye } from "./eye-Dn8Ure2_.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
function Login() {
  ...
  const { useEffect } = require2("react");
  useEffect(() => {
    setIsLogin(location.pathname !== "/signup");
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { style: { minHeight: "100vh", backgroundColor: "#1A1D24", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "3rem 1.5rem" }, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Helmet, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("title", { children: isForgotPassword ? "Reset Password | DeliverIQ" : isLogin ? "Sign In | DeliverIQ" : "Create Account | DeliverIQ" }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/login.tsx",
      lineNumber: 106,
      columnNumber: 9
    }, this) }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/login.tsx",

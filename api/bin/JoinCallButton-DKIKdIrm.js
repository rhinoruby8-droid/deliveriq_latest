...
import { m as createLucideIcon, r as reactExports, j as jsxDevRuntimeExports, B as Button, g as getUserToken } from "./entry-server-Dcy3SmRk.js";
/**
...
function JoinCallButton({
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    Button,
    {
      ...
      className: className || "border-[#C79A4E]/30 text-[#C79A4E] hover:text-[#0A0B0E] hover:bg-[#C79A4E] cursor-pointer shrink-0 text-xs rounded-lg px-4 h-9 font-bold bg-[#C79A4E]/10",
      children: isJoining ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "w-3 h-3 rounded-full border-2 border-current border-t-transparent animate-spin" }, void 0, false, {
          fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/JoinCallButton.tsx",
          lineNumber: 56,
          columnNumber: 11
        }, this),
        "Connecting..."

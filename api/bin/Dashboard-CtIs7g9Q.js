...
import { m as createLucideIcon, r as reactExports, j as jsxDevRuntimeExports, B as Button, X, v as cn, w as Menu } from "./entry-server-DE4KYu_X.js";
/**
...
function Dashboard({
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: cn("flex h-full w-full overflow-hidden bg-muted text-foreground", className), children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("aside", { className: cn(
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex h-14 items-center justify-between px-4 border-b border-border", children: [
        logo.href ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: logo.href, className: "flex items-center gap-2 font-semibold text-sm", children: [
          logo.image && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("img", { src: logo.image, alt: logo.text, className: "h-5 w-5" }, void 0, false, {
            fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/layouts/Dashboard.tsx",
            lineNumber: 95,
            columnNumber: 19
          }, this),
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("nav", { className: "flex-1 space-y-1 px-2 py-4 overflow-y-auto", children: [
          ...
          return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "a",
            {
              ...
              children: [
                ...
                item.badge !== void 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "ml-auto flex h-5 min-w-[20px] items-center justify-center rounded-full bg-muted border border-border/40 px-1 text-xs text-muted-foreground", children: item.badge }, void 0, false, {
                  fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/layouts/Dashboard.tsx",
                  lineNumber: 137,
                  columnNumber: 25
                }, this)
        ...
        navigation.secondary && navigation.secondary.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "my-4 border-t border-border" }, void 0, false, {
            fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/layouts/Dashboard.tsx",
            lineNumber: 149,
            columnNumber: 17
          }, this),
      ...
      sidebarFooter && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "border-t border-border p-3 text-xs text-muted-foreground", children: sidebarFooter }, void 0, false, {
        fileName: "C:/Users/A S U S/Downloads/DeliverIQ_2/DeliverIQ_2/src/layouts/Dashboard.tsx",
        lineNumber: 171,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-1 flex-col min-w-0 overflow-hidden relative bg-muted text-foreground", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:hidden flex h-10 items-center px-4 border-b border-border bg-background/60 backdrop-blur-md flex-shrink-0 justify-between relative z-10", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        Button,
        {
          variant: "ghost",
          size: "sm",

...
import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as createSlot$3, a as cn, o as cva, S as Slot$1, p as composeRefs, i as React4, q as useComposedRefs, v as reactDomExports, R as React, w as useFloating, x as offset, y as shift, z as flip, A as size, D as arrow, E as hide, G as autoUpdate, I as limitShift, k as ReactDOM, J as hideOthers, K as ReactRemoveScroll, b as Check } from "./entry-server-CdzZ2syk.js";
import { g as get, s as set, a as appendErrors, F as FormProvider, C as Controller, u as useFormContext, b as useForm } from "./DynamicForm-BkEFx9W_.js";
...
function SponsorIntakeForm() {
  ...
  if (isSuccess) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1A1D24] p-8 border border-[#2C2F38] rounded-sm text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#C79A4E] mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "mx-auto h-12 w-12" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-[#F0EDE8] mb-2", children: "Inquiry Received" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#8A8D96]", children: "Thank you for your interest! Our team will get back to you shortly to discuss sponsorship opportunities." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Form, { ...form, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: form.handleSubmit(onSubmit), className: "flex flex-col gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FormField,
      {
        control: form.control,
        name: "companyName",
        render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, { className: "flex flex-col gap-1.5 space-y-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(FormLabel, { className: "text-[10px] font-bold text-[#8A8D96] uppercase tracking-wider", children: [
            "Company Name ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#C79A4E]", "aria-hidden": "true", children: "*" })
          ] }),
      ...
      FormField,
      {
        ...
        render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, { className: "flex flex-col gap-1.5 space-y-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { onValueChange: field.onChange, defaultValue: field.value, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "px-4 py-2.5 bg-[#1A1D24] border border-[#2C2F38] rounded-sm text-sm text-[#F0EDE8] focus:ring-0 focus:outline-none focus:border-[#C79A4E]/60 transition-colors h-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a package..." }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-[#1A1D24] border-[#2C2F38]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "logo_placement", className: "text-[#F0EDE8] hover:bg-[#2C2F38] cursor-pointer focus:bg-[#2C2F38] focus:text-[#F0EDE8]", children: "Logo Placement" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "dedicated_session", className: "text-[#F0EDE8] hover:bg-[#2C2F38] cursor-pointer focus:bg-[#2C2F38] focus:text-[#F0EDE8]", children: "Dedicated Session Slots" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "registration_list", className: "text-[#F0EDE8] hover:bg-[#2C2F38] cursor-pointer focus:bg-[#2C2F38] focus:text-[#F0EDE8]", children: "Registration List Sharing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "custom", className: "text-[#F0EDE8] hover:bg-[#2C2F38] cursor-pointer focus:bg-[#2C2F38] focus:text-[#F0EDE8]", children: "Custom Package / Other" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormMessage, { className: "text-xs text-red-400" })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FormField,
      {
        ...
        name: "message",
        render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, { className: "flex flex-col gap-1.5 space-y-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, { className: "text-[10px] font-bold text-[#8A8D96] uppercase tracking-wider", children: "Additional Details (Optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-[#8A8D96] text-center mt-2", children: [
      "Protected by reCAPTCHA. ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://policies.google.com/privacy", target: "_blank", rel: "noreferrer", className: "hover:text-[#C79A4E] underline", children: "Privacy" }),
      " & ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://policies.google.com/terms", target: "_blank", rel: "noreferrer", className: "hover:text-[#C79A4E] underline", children: "Terms" }),
      " apply."
    ] })
  ] }) }) });
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden pt-20 pb-16 lg:pt-28 lg:pb-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:sticky lg:top-32 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-[#2C2F38] bg-[#21242C] rounded-sm overflow-hidden shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-5 border-b border-[#2C2F38] bg-[#1A1D24]/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold tracking-widest text-[#C79A4E] uppercase", children: "Custom Partnerships & Inquiries" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SponsorIntakeForm, {}) })
        ] }) })
      ] }) })
    ] }),
    tiers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: tiers.map((t2, i2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-6 border rounded-sm ${TIER_COLORS[t2.name] || "border-[#2C2F38] bg-[#21242C]/40"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold tracking-widest uppercase text-[#C79A4E] mb-2", children: t2.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold text-[#F0EDE8] mb-4", children: t2.priceLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: t2.benefits.map((b, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-[#8A8D96]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 13, className: "text-[#C79A4E] mt-0.5 shrink-0" }),
        " ",
        b
      ] }, j)) })
    ] }, i2)) }) }) }),

...
import { m as createLucideIcon, d as distExports, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, H as Helmet, a as ArrowRight, B as Button, g as getUserToken, l as fetchMe, o as fetchDashboardData, p as LogOut, q as removeUserToken } from "./entry-server-oxjGLzpd.js";
import { D as Dashboard, V as Video } from "./Dashboard-CZTWFcc7.js";
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-2 w-full sm:w-auto shrink-0", children: [
                    ...
                    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                      Button,
                      {
                        ...
                        size: "sm",
                        className: "bg-[#C79A4E] text-[#0A0B0E] hover:brightness-110 cursor-pointer text-xs font-bold h-9 rounded-xl flex-1 sm:flex-none",
                        children: joiningSessionId === session.id ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "inline-flex items-center gap-2", children: [
                          ...
                          lineNumber: 239,
                          columnNumber: 27
                        }, this) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "inline-flex items-center gap-1", children: [
                          "Join Call ",

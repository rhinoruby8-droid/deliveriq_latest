...
import { m as createLucideIcon, d as distExports, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, H as Helmet, a as ArrowRight, B as Button, l as fetchMe, o as fetchDashboardData, p as LogOut, q as removeUserToken } from "./entry-server-DIa57ZvY.js";
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      motion.div,
      {
        ...
        children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative w-full sm:w-72", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "input",
                {
                  ...
                  className: "w-full rounded-xl border border-border bg-[#121318] pl-9 pr-4 py-2 text-xs text-white placeholder:text-slate-500 focus:border-primary focus:outline-none"
                },
                void 0,
                false,
                {
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeIn, custom: 1, children: filteredSessions.length === 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative bg-[#121318] border border-dashed border-border rounded-2xl p-16 text-center flex flex-col items-center gap-4 overflow-hidden group", children: [
            ...
            motion.div,
            {
              variants: fadeIn,
              custom: index + 2,
              className: "bg-[#121318] border border-border/60 hover:border-primary/30 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden shadow-md",
              children: [

...
import { d as distExports, u as useCmsContent, r as reactExports, g as getUserToken, j as jsxDevRuntimeExports, A as AuthDialog, X, C as Calendar, a as ArrowRight, F as FALLBACK_CMS_CONTENT } from "./entry-server-EqKGxfE5.js";
import { S as SpeakerDialog } from "./SpeakerDialog-C2JvKxoP.js";
import { C as ChevronDown } from "./chevron-down-BkIMYdp6.js";
import { T as Tag } from "./tag-Bj-PjVZF.js";
import { C as Clock } from "./clock-Cg6nDn6E.js";
import { U as Users } from "./users-B0QmxqBO.js";
import { G as Globe } from "./globe-CS5VU0E3.js";
import { C as CirclePlay } from "./circle-play-CL-B3YbJ.js";
...
function SessionCard({ session, speakers, sponsors, isPast, currency, onTitleClick, onWatchReplay, onSpeakerClick }) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: `group border rounded-sm p-6 transition-all duration-200 flex flex-col diq-session-card ${isPast ? "border-[#2C2F38]/60 bg-[#1A1D24]/60 opacity-80 hover:opacity-100 hover:border-[#2C2F38]" : "border-[#2C2F38] bg-[#21242C]/40 hover:border-[#C79A4E]/30"}`, children: [
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4 pt-4 border-t border-[#2C2F38]/40 mt-auto diq-card-footer", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between pt-3 border-t border-[#2C2F38]/20 diq-card-actions-row", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "font-bold text-[#F0EDE8] text-sm", children: session.isFree ? "FREE" : new Intl.NumberFormat("en-US", { style: "currency", currency }).format(session.price || 0) }, void 0, false, {
          fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/SessionsList.tsx",
          lineNumber: 281,
          columnNumber: 11
        }, this),
...
function TopicsList() {
  ...
  if (topics.length === 0) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-red-500 py-4", children: "No topics found. Please add topics in the Admin panel." }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/TopicsList.tsx",
      lineNumber: 12,
      columnNumber: 12
    }, this);
  }
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "container mx-auto px-6 lg:px-8", children: topics.map((topic) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-[220px_1fr] gap-4 md:gap-12 py-8 border-t border-[#2C2F38] last:border-b", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-base font-semibold text-[#F0EDE8]", children: topic.title }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/TopicsList.tsx",
      lineNumber: 19,
      columnNumber: 11
    }, this),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-[#8A8D96] leading-relaxed self-center", children: topic.description }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/components/TopicsList.tsx",
      lineNumber: 20,
      columnNumber: 11
    }, this)

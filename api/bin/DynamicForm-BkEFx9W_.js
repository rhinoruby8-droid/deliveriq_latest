...
import { i as React4, r as reactExports, j as jsxRuntimeExports, u as useCmsContent, d as distExports } from "./entry-server-CdzZ2syk.js";
...
function DynamicForm({ formId }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BaseFormInner, { formId, executeRecaptcha: void 0 });
}
function BaseFormInner({ formId, executeRecaptcha }) {
  ...
  if (success) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1A1D24] p-8 border border-[#2C2F38] rounded-sm text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#C79A4E] mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-12 h-12 mx-auto", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-[#F0EDE8] mb-2", children: "Success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#8A8D96]", children: formDef.successMessage }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", id: `form-wrapper-${formId}`, children: [
    formDef.customCss && /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: formDef.customCss }),
    matchedSession && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1A1D24] border border-[#2C2F38] rounded-sm p-4 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-[#C79A4E] uppercase tracking-wider block mb-1", children: matchedSession.tag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-[#F0EDE8] mb-1 leading-snug", children: matchedSession.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#8A8D96] mb-3 leading-relaxed", children: matchedSession.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-[#8A8D96] block", children: [
        "Schedule: ",
        matchedSession.date,
        " @ ",
        matchedSession.time,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "flex flex-col gap-5", children: [
      ...
      formDef.fields.map((field) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: field.id, className: "text-[10px] font-bold text-[#8A8D96] uppercase tracking-wider", children: [
            field.label,
            " ",
            field.required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#C79A4E]", "aria-hidden": "true", children: "*" })
          ] }),
          field.type === "textarea" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[#8A8D96]", children: field.placeholder || field.label })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: field.type,

...
import { g as get, s as set, a as appendErrors, F as FormProvider, C as Controller, u as useFormContext, b as useForm } from "./DynamicForm-a5u0Tyf8.js";
import { C as ChevronDown } from "./chevron-down-rZBLhCnO.js";
  ...
  ({ className, type, ...props }, ref) => {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      "input",
      {
        type,
        className: cn(
          "flex h-12 w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-2 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary disabled:cursor-not-allowed disabled:opacity-50",
          className
        ),
        ref,
        ...props
      ...
      FormField,
      {
        ...
        render: ({ field }) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(FormItem, { className: "flex flex-col gap-2 space-y-0", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Select, { onValueChange: field.onChange, defaultValue: field.value, children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(FormControl, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SelectTrigger, { className: "h-12 w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-2 text-sm text-foreground transition-colors focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(SelectValue, { placeholder: "Select a package..." }, void 0, false, {
              fileName: "D:/deliverIQ-new/DeliverIQ_2/src/components/SponsorIntakeForm.tsx",
              lineNumber: 153,
              columnNumber: 23
            }, this) }, void 0, false, {
        ...
        render: ({ field }) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(FormItem, { className: "flex flex-col gap-2 space-y-0", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(FormControl, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            Textarea,
            {
              ...
              className: "w-full rounded-[10px] border border-border bg-[#14161B] px-4 py-3 text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary min-h-[100px] resize-none",
              ...field
            },
            void 0,
            false,

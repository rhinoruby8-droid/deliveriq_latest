...
import { u as useCmsContent, r as reactExports, j as jsxDevRuntimeExports, d as distExports, X, C as Calendar } from "./entry-server-BjmemSJV.js";
import { C as ChevronDown } from "./chevron-down-5gHu44WK.js";
import { T as Tag } from "./tag-DR-IsvTH.js";
import { C as Clock } from "./clock-DxGGXWFh.js";
import { U as Users } from "./users-CNI5IXIE.js";
import { G as Globe } from "./globe-MWEs2IUP.js";
import { C as CirclePlay } from "./circle-play-BzApJklA.js";
import { A as ArrowRight } from "./arrow-right-8xBpHEqq.js";
...
function SessionCard({ session, speakers, sponsors, isPast, onTitleClick }) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: `group border rounded-sm p-6 transition-all duration-200 flex flex-col ${isPast ? "border-[#2C2F38]/60 bg-[#1A1D24]/60 opacity-80 hover:opacity-100 hover:border-[#2C2F38]" : "border-[#2C2F38] bg-[#21242C]/40 hover:border-[#C79A4E]/30"}`, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap items-center justify-between gap-4 mb-4 border-b border-[#2C2F38]/40 pb-4", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: `text-[10px] font-semibold tracking-widest uppercase px-2.5 py-0.5 rounded-sm border ${isPast ? "text-[#8A8D96] bg-[#2C2F38]/20 border-[#2C2F38]/40" : "text-[#C79A4E] bg-[#C79A4E]/5 border-[#C79A4E]/20"}`, children: session.tag }, void 0, false, {
          fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
          lineNumber: 198,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs text-[#8A8D96] font-medium flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-xs text-[#8A8D96] font-semibold flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "mb-6 flex-1", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "button",
        {
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-[#8A8D96] leading-relaxed max-w-3xl line-clamp-2", children: session.description }, void 0, false, {
        fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
        lineNumber: 224,
        columnNumber: 9
      }, this)
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4 pt-4 border-t border-[#2C2F38]/40 mt-auto", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap gap-2 items-center", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] font-bold text-[#8A8D96] uppercase tracking-wider", children: "Presenters:" }, void 0, false, {
            fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
            lineNumber: 233,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap gap-1.5", children: [
            speakers.map((sp) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-1.5 bg-[#1A1D24] border border-[#2C2F38] pl-1 pr-2 py-0.5 rounded-full text-[10px]", children: [
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "img",
                {
                  src: sp.avatarUrl,
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "font-semibold text-[#F0EDE8]", children: sp.name }, void 0, false, {
                fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
                lineNumber: 244,
                columnNumber: 19
              }, this)
        ...
        sponsors.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap gap-2 items-center", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[9px] font-bold text-[#8A8D96] uppercase tracking-wider", children: "Sponsors:" }, void 0, false, {
            fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
            lineNumber: 254,
            columnNumber: 15
          }, this),
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-end gap-2 pt-3 border-t border-[#2C2F38]/20", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "button",
          {
            onClick: onTitleClick,
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-12", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "w-1.5 h-5 bg-[#C79A4E] rounded-full shrink-0" }, void 0, false, {
            fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
            lineNumber: 343,
            columnNumber: 13
          }, this),
        ...
        upcomingSessions.length === 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col items-center justify-center py-16 border border-dashed border-[#2C2F38] rounded-sm text-center", children: [
          ...
          lineNumber: 353,
          columnNumber: 13
        }, this) : /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: upcomingSessions.map((session) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          SessionCard,
          {
            session,
      ...
      pastSessions.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "w-1.5 h-5 bg-[#2C2F38] rounded-full shrink-0" }, void 0, false, {
            fileName: "C:/Users/Lenovo/Downloads/DeliverIQ (2)/DeliverIQ/DeliverIQ/src/components/SessionsList.tsx",
            lineNumber: 377,
            columnNumber: 15
          }, this),
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: visiblePast.map((session) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          SessionCard,
          {
            session,
            speakers: resolveSpeakers(session),

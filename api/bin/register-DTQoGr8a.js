...
import { u as useCmsContent, F as FALLBACK_CMS_CONTENT, d as distExports, r as reactExports, j as jsxDevRuntimeExports, H as Helmet, a as ArrowRight, l as fetchMe, s as setUserToken, g as getUserToken } from "./entry-server-Dcy3SmRk.js";
import { C as CheckoutButton } from "./CheckoutButton-BoNOIYt9.js";
import { C as CircleCheckBig } from "./circle-check-big-CU-OaTnw.js";
import { T as Tag } from "./tag-CPTxWLLw.js";
import { A as ArrowLeft } from "./arrow-left-Bl235uKP.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
function RegisterPage() {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Helmet, { children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("title", { children: "Register for Event — DeliverIQ" }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/register.tsx",
      lineNumber: 188,
      columnNumber: 9
    }, this) }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/register.tsx",
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("main", { className: "min-h-screen bg-[#1A1D24] text-[#F0EDE8] py-12 px-6 flex items-center justify-center relative", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "w-full max-w-3xl bg-[#21242C] border border-[#2C2F38] rounded-2xl shadow-2xl relative z-10", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-6 md:p-8", children: [
        matchedSession && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-[#1A1D24] border border-[#2C2F38] text-white p-4 rounded-xl mb-8 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-right shrink-0", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "bg-[#C79A4E]/10 text-[#C79A4E] border border-[#C79A4E]/20 text-xs font-bold px-2.5 py-1 rounded-md", children: matchedSession.isFree ? "FREE" : new Intl.NumberFormat("en-US", { style: "currency", currency: ((_a = cms.paymentConfig) == null ? void 0 : _a.currency) || "USD" }).format(matchedSession.price || 0) }, void 0, false, {
            fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/register.tsx",
            lineNumber: 210,
            columnNumber: 19
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-6", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-[#1A1D24] border border-[#2C2F38] rounded-xl p-5 text-sm flex flex-col gap-3", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex justify-between font-semibold text-[#8A8D96] border-b border-[#2C2F38] pb-2", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[#F0EDE8]", children: new Intl.NumberFormat("en-US", { style: "currency", currency: ((_b = cms.paymentConfig) == null ? void 0 : _b.currency) || "USD" }).format(originalPrice) }, void 0, false, {
                  fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/register.tsx",
                  lineNumber: 382,
                  columnNumber: 21
                }, this)
              ...
              !(matchedSession == null ? void 0 : matchedSession.isFree) && originalPrice > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-2 border-b border-[#2C2F38] pb-3 pt-1", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    "input",
                    {
                      ...
                      className: "h-10 flex-1 rounded-[8px] border border-[#2C2F38] bg-[#14161B] px-3 text-xs text-[#F0EDE8] uppercase transition-colors placeholder:text-[#8A8D96] focus:outline-none focus:border-[#C79A4E]"
                    },
                    void 0,
                    false,
                    {
                  ...
                  /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                    "button",
                    {
                      type: "button",
                      onClick: handleApplyCoupon,
                      className: "h-10 px-4 bg-[#2C2F38] text-white text-xs font-semibold rounded-[8px] hover:bg-[#3A3E4A] transition-colors shrink-0",
                      children: "Apply"
                    },
                    void 0,
                    false,
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex justify-between text-base font-bold text-white pt-1", children: [
                ...
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[#C79A4E]", children: new Intl.NumberFormat("en-US", { style: "currency", currency: ((_d = cms.paymentConfig) == null ? void 0 : _d.currency) || "USD" }).format(finalPrice) }, void 0, false, {
                  fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/register.tsx",
                  lineNumber: 414,
                  columnNumber: 21
                }, this)

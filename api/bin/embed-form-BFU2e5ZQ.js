...
import { d as distExports, j as jsxDevRuntimeExports } from "./entry-server-DMO3DLBc.js";
...
function EmbedFormPage() {
  ...
  if (!id) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-4 text-red-500", children: "Form ID not provided." }, void 0, false, {
      fileName: "D:/DeliverIQ (2)/DeliverIQ (2)/DeliverIQ/DeliverIQ_2/src/pages/embed-form.tsx",
      lineNumber: 8,
      columnNumber: 12
    }, this);
  }

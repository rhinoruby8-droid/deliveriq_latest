...
import { c as createLucideIcon, j as jsxDevRuntimeExports } from "./entry-server-f1u3uq1V.js";
import { D as DynamicForm } from "./DynamicForm-Bx437isl.js";
import { Z as Zap } from "./zap-B7p3fOQJ.js";
import { S as Star } from "./star-DpFiWjrP.js";
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { className: "relative overflow-hidden pt-20 pb-16 lg:pt-28 lg:pb-20", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": "true", style: {
        ...
        fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
        lineNumber: 16,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": "true", style: {
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "container mx-auto px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start", children: [
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "lg:sticky lg:top-32 w-full", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "border border-[#2C2F38] bg-[#21242C] rounded-sm overflow-hidden shadow-2xl", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-6 py-5 border-b border-[#2C2F38] bg-[#1A1D24]/40", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-[10px] font-semibold tracking-widest text-[#C79A4E] uppercase", children: "Apply to Speak" }, void 0, false, {
            fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
            lineNumber: 35,
            columnNumber: 19
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-6", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(DynamicForm, { formId: "speaker" }, void 0, false, {
            fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
            lineNumber: 40,
            columnNumber: 19
          }, this) }, void 0, false, {
    ...
    benefits.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("section", { className: "py-16 lg:py-20", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "container mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: benefits.map((b, i) => {
      const Icon = ICONS[b.icon] || Star;
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-6 border border-[#2C2F38] bg-[#21242C]/40 rounded-sm", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Icon, { size: 24, className: "text-[#C79A4E] mb-4" }, void 0, false, {
          fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
          lineNumber: 55,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h3", { className: "text-base font-bold text-[#F0EDE8] mb-2", children: b.title }, void 0, false, {
          fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
          lineNumber: 56,
          columnNumber: 21
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-[#8A8D96] leading-relaxed", children: b.description }, void 0, false, {
          fileName: "D:/DeliverIQ/DeliverIQ/src/components/page-renderers/SpeakersVisual.tsx",
          lineNumber: 57,
          columnNumber: 21
        }, this)

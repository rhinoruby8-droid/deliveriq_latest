...
import { m as createLucideIcon, d as distExports, j as jsxDevRuntimeExports, H as Helmet, M as Mail, C as Calendar, a as ArrowRight } from "./entry-server-DIa57ZvY.js";
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("main", { className: "min-h-[85vh] flex items-center justify-center bg-[#0A0B0E] relative overflow-hidden py-12", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "container mx-auto px-6 lg:px-8 max-w-2xl relative z-10", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        motion.div,
        {
          ...
          initial: "hidden",
          animate: "show",
          className: "bg-[#121318] border border-border/60 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden text-center flex flex-col items-center",
          children: [
            ...
            sessionId && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: itemVariants, className: "bg-[#17191E] border border-border/40 rounded-xl px-4 py-2 text-[10px] font-mono text-slate-500 mb-8 flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: itemVariants, className: "w-full text-left space-y-4 mb-10 pt-6 border-t border-border/40", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-start gap-4 p-4 bg-[#17191E]/30 border border-border/30 rounded-xl hover:border-border/60 transition-all", children: [

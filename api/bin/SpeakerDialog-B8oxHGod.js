...
import { u as useCmsContent, j as jsxDevRuntimeExports, D as Dialog, e as DialogContent, f as DialogHeader, h as DialogTitle, i as DialogDescription, C as Calendar, d as distExports, a as ArrowRight } from "./entry-server-DIa57ZvY.js";
...
function SpeakerDialog({ speaker, isOpen, onClose }) {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(DialogContent, { className: "sm:max-w-[500px] bg-card border-border text-white overflow-hidden shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex-1 min-w-0", children: [
        ...
        speaker.socialUrl && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "a",
          {
            ...
            target: "_blank",
            rel: "noreferrer",
            className: "inline-flex items-center gap-1.5 text-xs text-slate-400 hover:text-primary transition-colors mt-2",
            children: [

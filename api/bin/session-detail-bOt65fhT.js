...
import { d as distExports, u as useCmsContent, F as FALLBACK_CMS_CONTENT, r as reactExports, j as jsxDevRuntimeExports, C as Calendar, a as ArrowRight, g as getUserToken, H as Helmet } from "./entry-server-DIa57ZvY.js";
import { V as VideoPlayer } from "./VideoPlayer-DN1bIJzt.js";
import { P as PageHtmlRenderer } from "./PageHtmlRenderer-B8yyOvXE.js";
import { A as ArrowLeft } from "./arrow-left-DJ3PlYOY.js";
import { C as Clock } from "./clock-CeExO-S9.js";
import { T as Tag } from "./tag-B9YcofhL.js";
import { C as CirclePlay } from "./circle-play-B3EJLKwH.js";
import { C as CircleCheckBig } from "./circle-check-big-DLNbU2Lv.js";
import { m as motion } from "./proxy-Ebj0bgWW.js";
import { U as Users } from "./users-DMkBPeQ_.js";
import { G as Globe } from "./globe-CTB1J9FJ.js";
import "../index.js";
import "tty";
import "util";
import "os";
...
import "http2";
import "async_hooks";
import "./DynamicForm-a5u0Tyf8.js";
const fadeUp = {
...
function SessionDetailPage() {
  ...
  if (!session) {
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("main", { className: "min-h-screen flex flex-col items-center justify-center text-center px-6 gap-6", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-4xl font-black text-[#2C2F38]", children: "404" }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
        lineNumber: 86,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h1", { className: "text-2xl font-bold text-foreground", children: "Session not found" }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
        lineNumber: 87,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-sm text-muted-foreground", children: "This session may have been removed or the link is incorrect." }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
        lineNumber: 88,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(distExports.Link, { to: "/sessions", className: "inline-flex items-center gap-2 text-sm font-semibold text-primary hover:underline", children: [
  ...
  const widgets = {
    SessionSpeakers: speakers.length > 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeUp, custom: 0.2, className: "mb-10", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h2", { className: "text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-4 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4", children: speakers.map((sp) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-start gap-4 border border-border bg-card/40 rounded-sm p-4", children: [
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "font-bold text-foreground text-sm", children: sp.name }, void 0, false, {
            fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
            lineNumber: 309,
            columnNumber: 17
          }, this),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-xs text-primary font-medium mb-1", children: [
            sp.role,
            " · ",
            sp.organisation
          ] }, void 0, true, {
          ...
          sp.bio && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-xs text-muted-foreground leading-relaxed line-clamp-3", children: sp.bio }, void 0, false, {
            fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
            lineNumber: 311,
            columnNumber: 28
          }, this)
        ...
        sp.socialUrl && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: sp.socialUrl, target: "_blank", rel: "noreferrer", className: "text-muted-foreground hover:text-primary transition-colors shrink-0", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Globe, { size: 14 }, void 0, false, {
          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
          lineNumber: 315,
          columnNumber: 19
        }, this) }, void 0, false, {
    ...
    SessionSponsors: sponsors.length > 0 ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(motion.div, { variants: fadeUp, custom: 0.25, className: "mb-10", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h2", { className: "text-[11px] font-bold text-muted-foreground uppercase tracking-widest mb-4", children: "Session Sponsors" }, void 0, false, {
        fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
        lineNumber: 325,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-wrap gap-3", children: sponsors.map((sp) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-xs font-semibold text-muted-foreground", children: sp.name }, void 0, false, {
              fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
              lineNumber: 344,
              columnNumber: 15
            }, this),
            sp.tier && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-[10px] text-primary border border-primary/20 bg-primary/5 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider", children: sp.tier }, void 0, false, {
              fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
              lineNumber: 345,
              columnNumber: 27
            }, this)
    ...
    SessionRegistrationPanel: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "border border-border/60 bg-[#121318] rounded-2xl overflow-hidden shadow-2xl", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-6 py-5 border-b border-border/40 bg-[#17191E]/30 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("p", { className: "text-[10px] font-black tracking-[0.2em] text-primary uppercase", children: past ? "Session Ended" : "Register Interest" }, void 0, false, {
          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
          lineNumber: 354,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: `text-[9px] font-black tracking-wider uppercase px-3 py-1 rounded-md border ${past ? "text-slate-500 border-border bg-muted/30" : "text-emerald-400 border-emerald-500/20 bg-emerald-500/10"}`, children: past ? "Completed" : "Open" }, void 0, false, {
          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
          lineNumber: 357,
          columnNumber: 11
        }, this)
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "px-6 py-5 border-b border-border/40 bg-[#17191E]/10", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-3.5 text-xs", children: [
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center gap-3 text-slate-400", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Tag, { size: 13, className: "text-primary shrink-0" }, void 0, false, {
            fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
            lineNumber: 377,
            columnNumber: 15
          }, this),
      ...
      past ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-4", children: [
        session.videoUrl && session.isFree ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "p-4 border-b border-border/60", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(VideoPlayer, { url: session.videoUrl, title: session.title }, void 0, false, {
          fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
          lineNumber: 387,
          columnNumber: 17
        }, this) }, void 0, false, {
        ...
        return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("form", { onSubmit: handleSubmit, className: "px-6 py-6 flex flex-col gap-4.5", children: [
          ...
          isLoggedIn ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-background border border-border rounded-xl p-4.5 flex flex-col gap-2.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex justify-between border-b border-border pb-1.5 font-semibold", children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "input",
                {
                  ...
                  className: "bg-[#17191E] border border-border rounded-xl px-4 py-3 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-primary transition-colors"
                },
                void 0,
                false,
                {
          ...
          !session.isFree && originalPrice > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(jsxDevRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                  "input",
                  {
                    ...
                    className: "flex-1 bg-[#17191E] border border-border rounded-xl px-4 py-3 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-primary transition-colors"
                  },
                  void 0,
                  false,
                  {
            ...
            finalPrice > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex flex-col gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
                "select",
                {
                  ...
                  className: "bg-[#17191E] border border-border text-white px-4 py-3 text-xs rounded-xl focus:outline-none focus:border-primary transition-colors cursor-pointer",
                  children: [
            ...
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "border-t border-border/40 pt-4 mt-1 flex flex-col gap-1.5 text-xs text-slate-500", children: [
              ...
              /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex justify-between border-t border-border/40 pt-3 text-xs text-white font-bold", children: [
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { children: "Total to Pay:" }, void 0, false, {
                  fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
                  lineNumber: 533,
                  columnNumber: 23
                }, this),
                /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("span", { className: "text-primary text-sm font-extrabold", children: new Intl.NumberFormat("en-US", { style: "currency", currency: ((_c = cms.paymentConfig) == null ? void 0 : _c.currency) || "USD" }).format(finalPrice) }, void 0, false, {
                  fileName: "D:/deliverIQ-new/DeliverIQ_2/src/pages/session-detail.tsx",
                  lineNumber: 534,
                  columnNumber: 23
                }, this)

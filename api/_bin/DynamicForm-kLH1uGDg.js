...
import { R as React4, r as reactExports, j as jsxRuntimeExports, u as useCmsContent, d as distExports } from "./entry-server-QtrLgn1N.js";
...
function EmbedRenderer({ html }) {
  ...
  reactExports.useEffect(() => {
    ...
    const processedHtml = typeof window !== "undefined" ? html.replace(/(https?:)?\/\/(localhost|127\.0\.0\.1):\d+(\/embed\/form\/)/gi, `${window.location.origin}$3`) : html;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, className: "deliveriq-embed-container" });
}
function DynamicForm({ formId, forceNative }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BaseFormInner, { formId, forceNative, executeRecaptcha: void 0 });
}
function BaseFormInner({ formId, forceNative, executeRecaptcha }) {
  var _a, _b;
  ...
  if (formDef.formType === "embed" && !forceNative) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "deliveriq-embed-wrapper", id: `form-embed-${formId}`, children: [
      formDef.customCss && /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: formDef.customCss }),
      formDef.headerHtml && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "deliveriq-form-header", dangerouslySetInnerHTML: { __html: formDef.headerHtml } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(EmbedRenderer, { html: formDef.embedCode || "" })
    ] });
  }
  ...
  if (success) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background p-8 border border-border rounded-sm text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-12 h-12 mx-auto", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground mb-2", children: "Success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: formDef.successMessage }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl mx-auto flex flex-col gap-6", id: `form-wrapper-${formId}`, children: [
    formDef.customCss && /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: formDef.customCss }),
    formDef.headerHtml && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "deliveriq-form-header", dangerouslySetInnerHTML: { __html: formDef.headerHtml } }),
    matchedSession && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border rounded-sm p-4 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-primary uppercase tracking-wider block mb-1", children: matchedSession.tag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-foreground mb-1 leading-snug", children: matchedSession.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-3 leading-relaxed", children: matchedSession.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground block", children: [
        "Schedule: ",
        matchedSession.date,
        " @ ",
        matchedSession.time,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "flex flex-col gap-5", children: [
      errorMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-red-900/20 border border-red-500/50 rounded-sm text-red-200 text-sm", role: "alert", children: errorMsg }),
      formDef.fields.map((field) => {
        var _a2;
        const hasError = !!errors[field.id];
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: field.id, className: "text-[10px] font-bold text-muted-foreground uppercase tracking-wider", children: [
            field.label,
            " ",
            field.required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", "aria-hidden": "true", children: "*" })
          ] }),
          field.type === "textarea" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            "select",
            {
              ...
              children: [
                ...
                (_a2 = field.options) == null ? void 0 : _a2.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: opt, children: opt }, opt))
              ]
            }
          ) : field.type === "checkbox" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "checkbox",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: field.placeholder || field.label })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: field.type,
          ...
          hasError && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-400", role: "alert", children: "This field is required" })
        ] }, field.id);
      }),

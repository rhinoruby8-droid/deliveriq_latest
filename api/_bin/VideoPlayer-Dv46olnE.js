...
import { r as reactExports, j as jsxRuntimeExports } from "./entry-server-QtrLgn1N.js";
...
function VideoPlayer({ url, title = "Video", thumbnailUrl, className = "" }) {
  ...
  if (!info) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex items-center justify-center border border-border rounded-sm bg-background p-6 text-center ${className}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: url,
        target: "_blank",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              !autoThumb && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-semibold", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-16 h-16 rounded-full bg-primary flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { size: 32, className: "text-[#1A1D24] ml-0.5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-3 left-3 text-[10px] font-bold text-white/70 uppercase tracking-wider", children: [
